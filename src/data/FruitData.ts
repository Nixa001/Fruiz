...
export const FRUITS: FruitDefinition[] = [
  { id: 1, name: 'Jujube', radius: 22, color: 0xc02000, colorDark: 0x801500, score: 10, shape: 'circle', spawnWeight: 30 },
  { id: 2, name: 'Mûre', radius: 26, color: 0x2d1b4e, colorDark: 0x1c1132, score: 20, shape: 'circle', spawnWeight: 24 },
  { id: 3, name: 'Citron', radius: 31, color: 0xf0c010, colorDark: 0xa88500, score: 30, shape: 'circle', spawnWeight: 18 },
  { id: 4, name: 'Goyave', radius: 37, color: 0x90b030, colorDark: 0x60751f, score: 40, shape: 'circle', spawnWeight: 0 },
  ...
  { id: 11, name: 'Noix de coco', radius: 81, color: 0x965f1a, colorDark: 0x603c10, score: 320, shape: 'circle', spawnWeight: 0 },
  { id: 12, name: 'Pastèque', radius: 90, color: 0x2f9e44, colorDark: 0x1e6b2e, score: 500, shape: 'watermelon', spawnWeight: 0 },
];
